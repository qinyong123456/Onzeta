...
def main():
    ...
    parser.add_argument('--arch', type=str, default='ViT-B/32', help='CLIP model architecture')
    parser.add_argument('--batch_size', type=int, default=32, help='Batch size')
    parser.add_argument('--workers', type=int, default=4, help='Number of data loading workers')
    parser.add_argument('--cw', type=float, default=0.1, help='Learning rate for weight update')
    parser.add_argument('--cr', type=float, default=0.1, help='Learning rate for rho update')
    parser.add_argument('--beta', type=float, default=0.5, help='Combination coefficient')
    parser.add_argument('--tau_t', type=float, default=1.0, help='Temperature for text logits')
    parser.add_argument('--tau_i', type=float, default=1.0, help='Temperature for image logits')
